...
export const metadata: Metadata = {
  ...
  title: "RUNERGY · Daily Inbound Verification",
  ...
  twitter: { card: "summary_large_image", title: "RUNERGY · Daily Inbound Verification", description: "Compare system locations with daily physical scan locations by box number.", images: ["/og.png"] },
};
